...
// Meselen :610373930 Daha sonra o reqemler icinde min maxdan istifade edib en boyuk ve en kiçik reqemi tapacaqsiz 
...
//             item.phoneMinNumber = Math.min(...newPhone.filter((item) => item >= 0))
//             item.phoneMaxNumber = Math.max(...newPhone.filter((item) => item >= 0))
...
// const findRandomAddress = (array) => {
//     const index = Math.floor(Math.random() * array.length);
//     return arr[index].address;
// }


// console.log(findRandomAddress(arr));
...
// const getRandomEmail = (array) => {
//     const index = Math.floor(Math.random() *array.length);
//     return arr[index].email;
// }

// console.log(getRandomEmail(arr));